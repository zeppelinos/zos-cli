...
export default class AppManagerDeployer {
  constructor(owner) {
    this.owner = owner
    this.txParams = { from: owner }
  }

  async call(version, stdlibAddress = 0x0) {
    ...
    return new AppManagerWrapper(this.owner, this.packagedAppManager, this.factory, this.appDirectory, this.package, this.version)
  }
